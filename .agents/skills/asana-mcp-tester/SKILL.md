...
2. **Connection Test:** Attempt to invoke a read-only Asana tool (e.g., `mcp_asana_get_project` or `mcp_asana_search_objects`) using the Project ID found in `GEMINI.md`. 
