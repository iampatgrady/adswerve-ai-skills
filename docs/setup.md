...
Ensure you have an SSH key generated and added to your Bitbucket/GitHub account settings. This allows the AI to run `git push` without being prompted for passwords.

*If configuring for the CLI:*
